...
int TestTrio::test_semi_perimeter_computation()
{
    ...
    return 0 * assert_equal(a.semi_perimeter(b[0], b[1], b[2]), 13.1448 / 2.0,
...
int TestTrio::test_cut_triangle_computation()
{
    ...
    double yodh_area = Trio::planar_area(yodh_a.b_1, yodh_a.b_2, yodh_a.b_3) +
        Trio::planar_area(yodh_b.b_1, yodh_b.b_2, yodh_b.b_3) + Trio::planar_area(yodh_c.b_1, yodh_c.b_2, yodh_c.b_3) +
