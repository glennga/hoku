...
///
/// Source file for the TestSphericalTriangle class, as well as the main function to run the tests.

#include "test-spherical-triangle.h"
...
/// Enumerate all tests in TestSphericalTriangle.
///
/// @param test_case Number of the test case to run.
/// @return -1 if the test case does not exist. 0 otherwise.
int TestSphericalTriangle::enumerate_tests (int test_case) {
    switch (test_case) {
...
/// Run the tests in TestSphericalTriangle. Currently set to log all results. 
///
