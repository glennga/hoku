...
\begin{figure}
    ...
    \caption{
    Depicts the average accuracy of the resulting map of the unaltered Angle and triangle strategies, an Interior Angle strategy with a naive $b$ subset decision, and pyramid strategies without their verification steps given images with false positives, false negatives, and Gaussian noise.
