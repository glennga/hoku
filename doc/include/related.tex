...
linear search across an entire relation in a database and search for matching subsets.
Early star identification strategies focused on reducing the size of the relation to be searched, rather than the search
process itself.
In 1996, Quine (according to Spratling) was the first to reduce the relation search time from linear to log time
