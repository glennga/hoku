...
\begin{abstract}
    Given a set of query points within an image coordinate system, constellation queries find the matching points in a database of known points within a standard coordinate system.
