...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
    	...
    	\EndFunction
        \\
        \Function{Identify}{$b, R, \imageset$}
        \State $r \gets R[1]$ \Comment Select our candidate.
        \State \textbf{return} \Call{DMT}{$\imagesubset, r, \imageset$}
        \EndFunction
        \\
        \Procedure{Query}{$\imageset, \angdatabase$}
...
%        \\
        ...
        \EndFunction
        \\
        \Procedure{Query}{$\imageset, \texttt{TRI\_DB}$} 
