...
If all of these steps are successful, then an one-to-one map $a$ between the catalog subset and image subset is
...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \If{$\forall \ \hat{r} \ | \ (\hat{r} \in r \land \angle(\hat{r}, r_u) < f)$}
