...
\begin{subequations}
    ...
    The subset of stars from the image $b$ is selected using one of these combinations.
...
The literature states that a unique trio is to be found and be identifiable after the query step using $\theta$,
