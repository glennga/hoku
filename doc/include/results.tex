...
\begin{table}
    ...
    \begin{tabular}{m{0.18\columnwidth}|m{0.2\columnwidth}|m{0.2\columnwidth}|m{0.2\columnwidth}}
        ...
        \hline \hline
        \textbf{Angle} & 1.00 & MP1 & MP6 \\ \hline
        \textbf{Dot Angle} & 1.00 & MP2 & MP7 \\ \hline
        \textbf{Planar \newline Triangle} & 1.00 & MP3 & MP8 \\ \hline
        \textbf{Spherical \newline Triangle} & 1.00 & MP5 & MP10\\ \hline
        \textbf{Pyramid} & MP11 & MP4 & MP9
    \end{tabular}
    }
\end{table}
...
Third place in candidate set size is the Pyramid method, which had MP21 / 1000 points
