...
\begin{tikzpicture}[node distance=1.2cm]
    ...
    \node[scale=1](searchCatalog)[process, below of=pickQueryStars, yshift=-0.4cm] {Retrieve from Database};
    ...
    \node[scale=1](returnMap)[terminal, right of=confidentInMap, xshift = 2.2cm] {Return $b, h$};
    ...
    node[scale=1.3, xshift=1cm, yshift=-0.15cm]{$h: b \rightarrow K$} (confidentInMap);
