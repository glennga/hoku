...
\begin{tikzpicture}
    ...
    samples=100, no markers, legend pos=outer north east, enlargelimits=false
        ...
        \addplot +[domain=1:5, forget plot]{1};
        \addplot +[forget plot] coordinates {(5, 1) (5, 1.00849264777955)};
        \addplot +[domain=5:8]{-2.3292306442173216*ln(x) + 4.757244753386215};
        \addlegendentry{DOT}
        ...
        \addplot +[domain=1:3, forget plot]{1};
        \addplot +[forget plot] coordinates {(3, 1) (3, 1.016999618158761)};
        \addplot +[domain=3:8]{-1.1696544292494204*ln(x) + 2.301996347627258};
        \addlegendentry{PLN}
