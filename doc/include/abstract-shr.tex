...
\begin{abstract}
    ...
    We find that the Angle strategy is the most accurate, but slowest, given images with simulated false positives, false negatives, and Gaussian noise.
    A faster alternative, though slightly less accurate, is the Pyramid strategy in its simpler form.
\end{abstract}
