...
\begin{abstract}
    ...
    We find that the Pyramid strategy in its simpler form is the most accurate and fastest given images with false negatives and false positives, while the Angle strategy is the most accurate when dealing with images with perturbed points.
\end{abstract}
