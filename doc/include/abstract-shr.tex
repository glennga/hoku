...
\begin{abstract}
    ...
    We find that the Pyramid strategy in its simpler form (without additional verification) is the most accurate and fastest given images with false negatives, false positives, and Gaussian noise.
\end{abstract}
