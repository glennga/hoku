...
/// Cartesian space. The ratio of pixels to degrees must be passed (dpp), and it is assumed that the image itself is a
/// square. We assume that the given X and Y coordinates are relative to a (0, 0) *image* center.
/// Solution found here: https://stackoverflow.com/a/12734509
///
