...
/// Find the best matching pair using the appropriate PLAN table and by comparing planar areas and moments. Assumes
...
Star::list Plane::check_assumptions (const Star::list &candidates, const Trio::stars &r, const index_trio &hr_b) {
